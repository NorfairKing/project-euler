...
\begin{figure}[H]
\centering
\lstinputlisting[language=c, firstline=11, lastline=29]{\sol{002}{c}/naive.c}
...
\begin{align*}
    &= \frac{1}{\sqrt{5}}\left( \sum_{n=1}^{k}\Phi^{3n} - \sum_{n=1}^{k}(-\Phi)^{-3n} \right)\\
...
\begin{figure}[H]
\centering
\lstinputlisting[language=c, firstline=16, lastline=32]{\sol{002}{c}/solution.c}
\caption{A Naïve solution}
\end{figure}

\TODO{What's the total runtime complexity?}
