...
\begin{de}
  The set of \term{natural numbers} $\mathbb{N}$ is defined to contain $0$ and further recursively defined as the smallest that is closed under the successor function.
