...
\begin{prob}{1}{Multiples of 3 and 5}
  ...
  \begin{solutions}
    \begin{solution}{A naive solution}
      ...
      \begin{figure}[H]
        \centering
        \lstinputlisting[language=c, firstline=13, lastline=23]{\sol{001}{c}/naive.c}
    ...
    \begin{solution}{A better solution}
      ...
      \begin{figure}[H]
        \centering
        \lstinputlisting[language=c, firstline=14, lastline=31]{\sol{001}{c}/better.c}
        \caption{A better solution in C}
      \end{figure}

      The same can be done in haskell on two line:
      \begin{figure}[H]
        \centering
        \lstinputlisting[language=haskell, firstline=7, lastline=9]{\sol{001}{haskell}/better.hs}
