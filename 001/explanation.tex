...
\begin{prob}{1}{Multiples of 3 and 5}
    ...
    \begin{solutions}
        \begin{solution}{A naive solution}
            ...
            The naive solution, to check every number, gives us an $O(p)$ runtime.

            \begin{figure}[H]
                \centering
                \lstinputlisting[language=c, firstline=12, lastline=22]{\sol{001}{c}/naive.c}
        ...
        \begin{solution}{A better solution}
            ...
            \begin{figure}[H]
                \centering
                \lstinputlisting[language=c, firstline=13, lastline=30]{\sol{001}{c}/better.c}
                \caption{A better solution}
            \end{figure}

            In this solution, we check less than half of the numbers we did in the last solution.
            The same can be done in haskell on one line:
            \begin{figure}[H]
                \centering
                \lstinputlisting[language=c, firstline=7, lastline=7]{\sol{001}{haskell}/solution.hs}
        ...
        \begin{solution}{A constant-time solution}
            ...
            The critical insight is here the explicit formula for the sum of the first $n$ nont-zero integers:\prref{pr:sum-of-first-n-natural-numbers}
            \[
            ...
            \begin{figure}[H]
                \centering
                \lstinputlisting[language=c, firstline=23, lastline=26]{\sol{001}{c}/solution.c}
